...
import fr.unice.modalis.fsm.actions.unit.ReadResult
 ...
 */
case class ValueConstraint(val value: ReadResult, val threshold: Int, val operator: String) extends Action {
